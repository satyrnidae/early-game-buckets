...
public class BucketModBlockStateProvider extends BlockStateProvider {
    public BucketModBlockStateProvider(final DataGenerator gen,
                                       final String modId,
    ...
    protected void registerStatesAndModels() {
        final var kilnModel = this.models()
        ...
        final var kilnOnModel = this.models()
        ...
        this.itemModels().getBuilder(BucketItems.KILN.getId().toString()).parent(kilnModel);
    }

    @Override
    public String getName() {
        return "Early Game Buckets Block State and Block Model Provider";
    }
}
