...
public class BucketModItemTagsProvider extends ItemTagsProvider {
    ...
    public BucketModItemTagsProvider(final DataGenerator arg,
                                     final BlockTagsProvider arg2,
                                     final String modId,
    ...
    protected void addTags() {
        final var conventionalMilkBucketsTag = TagKey.create(Registry.ITEM_REGISTRY,
                new ResourceLocation("c", "buckets/milk"));
        ...
        this.tag(conventionalMilkBucketsTag).addTag(BucketTags.Items.MILK_BUCKETS);
        final var forgeMilkTag = TagKey.create(Registry.ITEM_REGISTRY, new ResourceLocation("forge", "milk"));
        this.tag(forgeMilkTag).addTag(BucketTags.Items.MILK_BUCKETS);
        this.tag(BucketTags.Items.SUGAR).add(Items.SUGAR);
        this.tag(BucketTags.Items.EGGS)
                .add(Items.EGG)
                .addOptionalTag(new ResourceLocation("c", "eggs"))
                .addOptionalTag(Tags.Items.EGGS.location());
        this.tag(BucketTags.Items.WHEAT).add(Items.WHEAT).addOptionalTag(Tags.Items.CROPS_WHEAT.location());
        ...
        final var forgeCeramicBucketsTag = TagKey.create(Registry.ITEM_REGISTRY,
                new ResourceLocation("forge", "buckets/ceramic"));
        ...
        final var conventionalCeramicBucketsTag = TagKey.create(Registry.ITEM_REGISTRY,
                new ResourceLocation("c", "buckets/ceramic"));
        ...
        final var forgeWoodenBucketsTag = TagKey.create(Registry.ITEM_REGISTRY,
                new ResourceLocation("forge", "buckets/wooden"));
        ...
        final var conventionalWoodenBucketsTag = TagKey.create(Registry.ITEM_REGISTRY,
                new ResourceLocation("c", "buckets/wooden"));
        ...
        this.tag(BucketTags.Items.WOODEN_BUCKETS)
                ...
                .addOptionalTag(conventionalCeramicBucketsTag.location());
        final var forgeClayBucketsTag = TagKey.create(Registry.ITEM_REGISTRY,
                new ResourceLocation("forge", "buckets/clay"));
        ...
        final var conventionalClayBucketsTag = TagKey.create(Registry.ITEM_REGISTRY,
                new ResourceLocation("c", "buckets/clay"));
        ...
        final var forgeIronBucketsTag = TagKey.create(Registry.ITEM_REGISTRY,
                new ResourceLocation("forge", "buckets/iron"));
        ...
        final var conventionalIronBucketsTag = TagKey.create(Registry.ITEM_REGISTRY,
                new ResourceLocation("c", "buckets/iron"));
        ...
        this.tag(phc2ForgeMilk).addTag(BucketTags.Items.MILK_BUCKETS);
    }

    private void copyItemTag(final TagKey<Item> source, final TagKey<Item> destination) {
        final TagBuilder destBuilder = this.getOrCreateRawBuilder(destination);
        final TagBuilder sourceBuilder = this.getOrCreateRawBuilder(source);
    ...
    public String getName() {
        return "Early Game Buckets Item Tag Provider";
    }
}
