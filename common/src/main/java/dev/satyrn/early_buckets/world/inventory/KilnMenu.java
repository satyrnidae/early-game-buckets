...
public class KilnMenu extends AbstractFurnaceMenu {
    ...
    public KilnMenu(int containerId, Inventory playerInventory) {
        super(BucketMenuTypes.KILN_MENU.get(), BucketRecipeTypes.FIRING.get(), RecipeBookType.FURNACE, containerId, playerInventory);
    }

    public KilnMenu(int containerId, Inventory playerInventory, Container kilnContainer, ContainerData kilnData) {
        super(BucketMenuTypes.KILN_MENU.get(), BucketRecipeTypes.FIRING.get(), RecipeBookType.FURNACE, containerId, playerInventory, kilnContainer, kilnData);
    }
}
