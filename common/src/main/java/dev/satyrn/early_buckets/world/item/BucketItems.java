...
public final class BucketItems {
    ...
    static {
        ...
        CERAMIC_AXOLOTL_BUCKET = ITEMS.register("ceramic_axolotl_bucket", () -> new CeramicEntityBucketItem(
                EntityType.AXOLOTL, Fluids.WATER, SoundEvents.BUCKET_FILL_AXOLOTL,
                new Item.Properties().tab(CreativeModeTab.TAB_MISC)
                        .defaultDurability(CustomBucket.CERAMIC_BUCKET_DURABILITY)
                        .craftRemainder(CERAMIC_BUCKET.get())));
        CERAMIC_COD_BUCKET = ITEMS.register("ceramic_cod_bucket", () -> new CeramicEntityBucketItem(
                EntityType.COD, Fluids.WATER, SoundEvents.BUCKET_FILL_FISH,
                new Item.Properties().tab(CreativeModeTab.TAB_MISC)
                        .defaultDurability(CustomBucket.CERAMIC_BUCKET_DURABILITY)
                        .craftRemainder(CERAMIC_BUCKET.get())));
        CERAMIC_MILK_BUCKET = ITEMS.register("ceramic_milk_bucket", () -> new CeramicMilkBucketItem(
                new Item.Properties().tab(CreativeModeTab.TAB_MISC)
                        .defaultDurability(CustomBucket.CERAMIC_BUCKET_DURABILITY)
                        .craftRemainder(CERAMIC_BUCKET.get())));
        CERAMIC_PUFFERFISH_BUCKET = ITEMS.register("ceramic_pufferfish_bucket", () -> new CeramicEntityBucketItem(
                EntityType.PUFFERFISH, Fluids.WATER, SoundEvents.BUCKET_FILL_FISH,
                new Item.Properties().tab(CreativeModeTab.TAB_MISC)
                        .defaultDurability(CustomBucket.CERAMIC_BUCKET_DURABILITY)
                        .craftRemainder(CERAMIC_BUCKET.get())));
        CERAMIC_SALMON_BUCKET = ITEMS.register("ceramic_salmon_bucket", () -> new CeramicEntityBucketItem(
                EntityType.SALMON, Fluids.WATER, SoundEvents.BUCKET_FILL_FISH,
                new Item.Properties().tab(CreativeModeTab.TAB_MISC)
                        .defaultDurability(CustomBucket.CERAMIC_BUCKET_DURABILITY)
                        .craftRemainder(CERAMIC_BUCKET.get())));
        CERAMIC_TADPOLE_BUCKET = ITEMS.register("ceramic_tadpole_bucket", () -> new CeramicEntityBucketItem(
                EntityType.TADPOLE, Fluids.WATER, SoundEvents.BUCKET_FILL_TADPOLE,
                new Item.Properties().tab(CreativeModeTab.TAB_MISC)
                        .defaultDurability(CustomBucket.CERAMIC_BUCKET_DURABILITY)
                        .craftRemainder(CERAMIC_BUCKET.get())));
        CERAMIC_TROPICAL_FISH_BUCKET = ITEMS.register("ceramic_tropical_fish_bucket", () -> new CeramicEntityBucketItem(
                EntityType.TROPICAL_FISH, Fluids.WATER, SoundEvents.BUCKET_FILL_FISH,
                new Item.Properties().tab(CreativeModeTab.TAB_MISC)
                        .defaultDurability(CustomBucket.CERAMIC_BUCKET_DURABILITY)
                        .craftRemainder(CERAMIC_BUCKET.get())));
        CERAMIC_WATER_BUCKET = ITEMS.register("ceramic_water_bucket", () -> new CeramicBucketItem(Fluids.WATER,
                new Item.Properties().tab(CreativeModeTab.TAB_MISC)
                        .defaultDurability(CustomBucket.CERAMIC_BUCKET_DURABILITY)
                        .craftRemainder(CERAMIC_BUCKET.get())));
        CERAMIC_POWDER_SNOW_BUCKET = ITEMS.register("ceramic_powder_snow_bucket", () -> new CeramicPowderSnowBucketItem(
                Blocks.POWDER_SNOW, SoundEvents.POWDER_SNOW_PLACE, new Item.Properties().tab(CreativeModeTab.TAB_MISC)
                .defaultDurability(CustomBucket.CERAMIC_BUCKET_DURABILITY)
                .craftRemainder(CERAMIC_BUCKET.get())));
        CERAMIC_LAVA_BUCKET = ITEMS.register("ceramic_lava_bucket", () -> new CeramicBucketItem(Fluids.LAVA,
                new Item.Properties().tab(CreativeModeTab.TAB_MISC)
                        .defaultDurability(CustomBucket.CERAMIC_BUCKET_DURABILITY)));
        CLAY_BUCKET = ITEMS.register("clay_bucket", () -> new ClayBucketItem(
        ...
        CLAY_AXOLOTL_BUCKET = ITEMS.register("clay_axolotl_bucket", () -> new CustomEntityBucketItem(EntityType.AXOLOTL,
                Fluids.WATER, SoundEvents.BUCKET_FILL_AXOLOTL,
                new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(1).craftRemainder(Items.CLAY_BALL)) {
            @Override
        ...
        CLAY_POWDER_SNOW_BUCKET = ITEMS.register("clay_powder_snow_bucket", () -> new CustomPowderSnowBucketItem(
                Blocks.POWDER_SNOW, SoundEvents.POWDER_SNOW_PLACE, Items.CLAY_BALL,
                new Item.Properties().tab(CreativeModeTab.TAB_MISC).craftRemainder(Items.CLAY_BALL).stacksTo(1)));
        ...
        WOODEN_AXOLOTL_BUCKET = ITEMS.register("wooden_axolotl_bucket", () -> new WoodenEntityBucketItem(
                EntityType.AXOLOTL, Fluids.WATER, SoundEvents.BUCKET_FILL_AXOLOTL,
                new Item.Properties().tab(CreativeModeTab.TAB_MISC)
                        .defaultDurability(CustomBucket.WOODEN_BUCKET_DURABILITY)
                        .craftRemainder(WOODEN_BUCKET.get())));
        WOODEN_COD_BUCKET = ITEMS.register("wooden_cod_bucket", () -> new WoodenEntityBucketItem(
                EntityType.COD, Fluids.WATER, SoundEvents.BUCKET_FILL_FISH,
                new Item.Properties().tab(CreativeModeTab.TAB_MISC)
                        .defaultDurability(CustomBucket.WOODEN_BUCKET_DURABILITY)
                        .craftRemainder(WOODEN_BUCKET.get())));
        ...
        WOODEN_PUFFERFISH_BUCKET = ITEMS.register("wooden_pufferfish_bucket", () -> new WoodenEntityBucketItem(
                EntityType.PUFFERFISH, Fluids.WATER, SoundEvents.BUCKET_FILL_FISH,
                new Item.Properties().tab(CreativeModeTab.TAB_MISC)
                        .defaultDurability(CustomBucket.WOODEN_BUCKET_DURABILITY)
                        .craftRemainder(WOODEN_BUCKET.get())));
        WOODEN_SALMON_BUCKET = ITEMS.register("wooden_salmon_bucket", () -> new WoodenEntityBucketItem(
                EntityType.SALMON, Fluids.WATER, SoundEvents.BUCKET_FILL_FISH,
                new Item.Properties().tab(CreativeModeTab.TAB_MISC)
                        .defaultDurability(CustomBucket.WOODEN_BUCKET_DURABILITY)
                        .craftRemainder(WOODEN_BUCKET.get())));
        WOODEN_TADPOLE_BUCKET = ITEMS.register("wooden_tadpole_bucket",
                () -> new WoodenEntityBucketItem(EntityType.TADPOLE, Fluids.WATER, SoundEvents.BUCKET_FILL_TADPOLE,
                        new Item.Properties().tab(CreativeModeTab.TAB_MISC)
                                .defaultDurability(CustomBucket.WOODEN_BUCKET_DURABILITY)
                                .craftRemainder(WOODEN_BUCKET.get())));
        WOODEN_TROPICAL_FISH_BUCKET = ITEMS.register(
                "wooden_tropical_fish_bucket",
        ...
        WOODEN_WATER_BUCKET = ITEMS.register("wooden_water_bucket",
                () -> new WoodenBucketItem(Fluids.WATER, new Item.Properties().tab(CreativeModeTab.TAB_MISC)
                        .defaultDurability(CustomBucket.WOODEN_BUCKET_DURABILITY)
                        .craftRemainder(WOODEN_BUCKET.get())));
        WOODEN_POWDER_SNOW_BUCKET = ITEMS.register(
                "wooden_powder_snow_bucket",
                () -> new CustomPowderSnowBucketItem(Blocks.POWDER_SNOW, SoundEvents.POWDER_SNOW_PLACE,
                        ...
                        .defaultDurability(CustomBucket.WOODEN_BUCKET_DURABILITY)
                        .craftRemainder(WOODEN_BUCKET.get())));
        KILN = ITEMS.register("kiln", () -> new BlockItem(BucketBlocks.KILN.get(), new Item.Properties().tab(CreativeModeTab.TAB_DECORATIONS)));
    }
