...
public final class BucketModCommon {
    ...
    public static final ResourceLocation CRAFTING_SHAPED_BREAKABLE_RECIPE_ID = new ResourceLocation(MOD_ID, "crafting_shaped_breakable");
    public static final ResourceLocation FIRING_RECIPE_ID = new ResourceLocation(MOD_ID, "firing");

    public static final CustomFilledBucketTrigger FILL_BUCKET = CriteriaTriggersAccessor.callRegister(new CustomFilledBucketTrigger());
