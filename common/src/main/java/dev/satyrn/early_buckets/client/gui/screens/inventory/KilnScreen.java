...
import dev.satyrn.early_buckets.mixin.client.gui.screens.inventory.AbstractFurnaceScreenAccessor;
...
public class KilnScreen extends AbstractFurnaceScreen<KilnMenu> {
    ...
    public KilnScreen(final KilnMenu kilnMenu, final Inventory inventory, final Component component) {
    ...
    public void init() {
        ...
        this.recipeBookComponent.init(this.width, this.height, Objects.requireNonNull(this.minecraft),
